...
const EditDonationScreen = ({ route, navigation }) => {
    ...
    const [campaign, setCampaign] = useState(donation.campaign || null); // Expecting object or ID
    const [paymentMode, setPaymentMode] = useState(donation.paymentMode || 'UPI');
    const [donorType, setDonorType] = useState(donation.donorType || 'Individual');
    ...
    const fetchCampaigns = async () => {
        try {
            ...
            // If campaign is just an ID, find the object
            if (campaign && typeof campaign === 'string') {
                const found = data.find(c => c._id === campaign);
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.form}>
                    ...
                    <TouchableOpacity
                        ...
                        disabled={loading}
                    >
                        <Text style={styles.buttonText}>{loading ? 'Updating...' : 'Update Donation'}</Text>
                    </TouchableOpacity>
